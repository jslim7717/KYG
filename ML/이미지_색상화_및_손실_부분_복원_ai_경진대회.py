...
Original file is located at
    https://colab.research.google.com/drive/1ythOtrPxyUVOaegLxmyKd8O2n2j9bt90
...
zip_file_path = '/content/drive/MyDrive/image_in.zip'
extract_folder_path = '/content/image_in_unzipped'
...
print(f"'{zip_file_path}'의 압축을 '{extract_folder_path}'에 풀었습니다.")
...
# 경로 설정
origin_dir = '/content/image_in_unzipped/train_gt'  # 원본 이미지 폴더 경로
damage_dir = '/content/image_in_unzipped/train_input'  # 손상된 이미지 폴더 경로
test_dir = '/content/image_in_unzipped/test_input'     # test 이미지 폴더 경로
