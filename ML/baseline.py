...
Original file is located at
    https://colab.research.google.com/drive/1kJQU8zpR6KcPLCAiefXHj9TeYKmTG9XV
...
# 경로 설정
origin_dir = '/home/work/.jiu/open/train_gt'  # 원본 이미지 폴더 경로
damage_dir = '/home/work/.jiu/open/train_input'  # 손상된 이미지 폴더 경로
test_dir = '/home/work/.jiu/open/test_input'     # test 이미지 폴더 경로
...
zip_filename = "lr_0.003_epoch_20.zip"
